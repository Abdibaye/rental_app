      ...
      {isOpen && (
        <>
          ...
          >
            <motion.div
              ref={modalRef}
              className={`${modalSizes[size]} relative mx-auto w-full max-h-[80vh] overflow-y-auto rounded-xl border bg-background p-4 text-foreground shadow-xl sm:p-6`}
            ...
            >
              ...
              <div className="mb-4 flex items-center justify-between">
                ...
                <motion.button
                  className="ml-auto rounded-full p-1.5 transition-colors hover:bg-secondary/60"
                  onClick={onClose}
